...
function Comment({
  ...
  function renderCommentButtons(commentObj: IComment) {
    const commentObjString = encodeURIComponent(JSON.stringify(commentObj))
    const campgroundString = encodeURIComponent(JSON.stringify(campground))
    const loggedInAsAdminString = encodeURIComponent(JSON.stringify(loggedInAsAdmin))
        ...
        <div className="float-right">
          <Link href={{
            ...
            query: {
              ...
              loggedInAsAdmin: loggedInAsAdminString
            }
          }}
          >
            <Button
